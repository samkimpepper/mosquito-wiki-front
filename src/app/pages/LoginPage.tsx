      ...
      <div className="flex items-center justify-center" style={{ minHeight: 'calc(100vh - 57px)' }}>
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8 border border-gray-200 rounded-xl p-6">
            <p className="text-xs font-semibold tracking-widest text-gray-400 uppercase mb-1">// 로그인</p>
            <p className="text-xs text-gray-400">소셜 계정으로 간편하게 로그인하세요</p>
            ...
            <div className="space-y-2 mt-6">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-5 py-3 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:border-gray-300 transition-colors text-sm text-gray-700"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 px-5 py-3 bg-[#FEE500] border border-[#FEE500] rounded-lg hover:bg-[#FDD835] transition-colors text-sm text-[#181600]"
              >
                <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
