...
export function Sidebar({ userProfile, isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* 사이드바 */}
      <div className={`
        w-72 h-screen bg-white flex flex-col fixed left-0 top-0 z-50
      ...
      `}>
        ...
        <div className="px-3 py-4 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="text-sm font-medium text-gray-800">{userProfile.username}</span>
          </div>
        </div>

        {/* 메뉴 아이템들 */}
        <nav className="flex-1 px-3 py-3 flex flex-col items-end">
